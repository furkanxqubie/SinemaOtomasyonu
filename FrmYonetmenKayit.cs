    ...
    public partial class FrmYonetmenKayit : Form
    {
        ...
        private void btnKaydet_Click(object sender, EventArgs e)
        {
            ...
            if (txtAd.Text != "" && txtSoyad.Text != "" && txtBiyografi.Text != "")
            {
                ...
                baglanti.Open();
                SqlCommand kayit = new SqlCommand("insert into tbl_Yonetmenler (ADSOYAD,CINSIYET,YAS,BIYOGRAFI) VALUES (@p1,@p2,@p3,@p4)", baglanti);
        ...
        {
            MessageBox.Show("Biyografiye yazabileceğiniz metin sayısı");
        }
    }
}
